...
<body>
    <div class="h-dvh overflow-y-scroll snap-y snap-mandatory scroll-smooth">
        <div id="hola" class="snap-start h-dvh w-full bg-black relative">
            <img class="h-full w-full object-cover opacity-80 absolute top-0" src="{{ Vite::asset('resources/images/pinguino.webp') }}" alt="pinguino">
        ...
        <div id="voy"
            class="snap-start min-h-dvh w-full bg-white  p-5 xl:content-center text-gray-900 gap-5 relative">
            <div class="flex flex-col gap-5 xl:max-w-2xl mx-auto">
                <h2 class="text-4xl xl:text-7xl fade-in">¡VOY EN BUSCA DE <span class="text-red-600">AVENTURAS</span>!
                </h2>
                <p class="xl:text-xl load-hidden fade-in">El formidable pingüino emperador&nbsp;(<em
                        class="text-red-600">Aptenodytes
                        forsteri</em>) es una especie endémica de la Antártida, y <strong>nunca se ha registrado la
                        presencia de este animal tan al norte</strong> de sus tierras, así que podemos imaginar cuál fue
                    la sorpresa de los bañistas, y más tarde también de los expertos, cuando este enorme ejemplar
                    aterrizó en una de las playas más turísticas de la región a principios de noviembre, después de su
                    gran viaje.&nbsp;</p>
                <p class="xl:text-xl load-hidden fade-in">A simple vista,<strong> el pingüino mostraba signos de
                        desnutrición</strong>, así
                    que los especialistas en animales silvestres del Departamento de Biodiversidad y Conservación del
                    Gobierno de Australia consideraron que debían acogerlo para <strong>garantizar su cuidado y evitar
                        que fuera atacado</strong> por depredadores locales.&nbsp;</p>
            </div>
        ...
        <div id="como" class="snap-start min-h-dvh w-full bg-black xl:content-center  p-5 text-white gap-5 relative">
            <div class="flex flex-col gap-5 xl:max-w-2xl mx-auto">
                ...
                <h2 class="text-4xl xl:text-7xl fade-in">¿CÓMO PUDO NADAR <span class="text-red-600">TAN LEJOS</span>?</h2>
                <p class="xl:text-xl fade-in">Pues bien, por una parte, y aunque cada especie tiene unas características algo
                    distintas, todas
        ...
        <div id="peligros" class="snap-start min-h-dvh w-full bg-gradient-to-br from-red-600 to-red-800 xl:content-center  p-5 text-white relative">
            <div class="flex flex-col gap-5 xl:max-w-2xl mx-auto">

                <h2 class="text-4xl xl:text-7xl uppercase fade-in">Los <span class="text-gray-900">peligros</span> que acechan a
                    los
                    pingüinos
                </h2>
                <p class="xl:text-xl fade-in">Cada 25 de abril se celebra el<strong> Día Mundial del Pingüino</strong>, una
                    iniciativa
                    internacional
                ...
                <p class="xl:text-xl fade-in">De las 18 especies de pingüino que habita el planeta, <strong>10 se encuentran
                        amenazadas, y de
                        estas, 5
        ...
        <div id="sobre" class="snap-start h-dvh w-full bg-black relative">
            <img class="h-full w-full object-cover opacity-20 absolute top-0 blur" src="{{ Vite::asset('resources/images/yo.webp') }}" alt="yo">
            <div class="absolute top-0 p-5 text-white relative h-full xl:content-center">
                <div class="flex flex-col gap-5 xl:max-w-2xl mx-auto">

                    <h2 class="text-4xl xl:text-7xl fade-in">AHORA UN POCO <span class="text-red-600">SOBRE MÍ</span></h2>
