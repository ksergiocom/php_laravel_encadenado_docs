...
@section('content')
    <div class="h-dvh overflow-y-scroll snap-y snap-mandatory scroll-smooth">
        ...
        <div class="snap-start">
                ...
                <div class="flex flex-col md:flex-row gap-5 w-full items-stretch lg:gap-15">
                    <div class="flex flex-col gap-5 md:w-1/2 mx-auto">
                        ...
                        <p class="xl:text-xl fade-in">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur
                            nesciunt porro provident earum maiores quis dolores voluptate? Expedita minus nisi sit,
                            praesentium
                            fugiat nulla possimus temporibus, vel, dicta rem id culpa ad asperiores ratione nesciunt. Ad
                            consectetur numquam vero quo?</p>
                        <p class="xl:text-xl fade-in pb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Aspernatur
                            nesciunt porro provident earum maiores <strong class="text-green-600">quis dolores
                                voluptate?</strong> Expedita minus nisi sit,
                            praesentium
                            fugiat nulla possimus temporibus, vel, dicta rem id culpa ad asperiores ratione nesciunt. Ad
                            consectetur numquam vero quo?</p>
                    </div>
                    <div class="md:w-1/2 relative min-h-[300px]">
                        <img class="absolute inset-0 w-full h-full object-cover object-center rounded-lg"
            ...
            <div id="anuncios" class="min-h-dvh w-full bg-gray-50  p-5 xl:p-7 text-gray-900 gap-5 relative">
            ...
            <footer
                class="flex flex-col gap-2 mt-1 text-xs sm:text-sm text-center bg-black w-full p-3 xl:p-5 text-gray-200 relative">
                <span>GANADERÍA DE RAZAS SELECTAS, S.A. — CIF A47411285.</span> <span class="text-xs">Inscrita en el
                    Registro
                    Mercantil de
                    Valladolid, Tomo
